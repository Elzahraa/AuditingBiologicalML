%FeatureExtraction_Marcotte_M3M4M5M7_r4r3r2r1
...
%% Features M3 - r4
load Features_M3_MarcotteHH.mat Features
...
clear Features
save  Features_M3_MarcotteHH_r4.mat Features_Rand
clear Features_Rand
...
clear Features
save  Features_M3_MarcotteHH_r3.mat Features_Rand
clear Features_Rand
...
save Features_M3_MarcotteHH_r2.mat Features_Rand AvgLength
...
save Features_M3_MarcotteHH_r1.mat Features_Rand
clear Features_Rand Features_Rand
...
%%
%% Features M4 - r4
load  Features_M4_MarcotteHH.mat Features
Features_Rand = cell(training_rounds,1);
for R = 1:training_rounds
    crnt = zeros(size(Features));
    for r=1:size(Features,1)
...
clear Features
save  Features_M4_MarcotteHH_r4.mat Features_Rand
clear Features_Rand
...
clear Features
save  Features_M4_MarcotteHH_r3.mat Features_Rand
clear Features_Rand
...
clear Features
save  Features_M4_MarcotteHH_r2.mat Features_Rand AvgLength
clear Features_Rand
...
clear Features
save  Features_M4_MarcotteHH_r1.mat Features_Rand AvgLength
clear Features_Rand
