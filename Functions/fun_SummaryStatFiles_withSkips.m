function [ Summary , SummaryAUC] = fun_SummaryStatFiles_withSkips( Paramters, Stat_Tr, SVr, ...
    OutputFileHeader, SumFile, TIMEs)
%fun_SummaryStatFiles_withSkips summarizes training, validation, and test performances
