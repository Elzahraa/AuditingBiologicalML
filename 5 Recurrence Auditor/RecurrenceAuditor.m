...
%% Recurrence Auditing
load SoringFunctionResult.mat RecurrenceAUC
% Coompare AUCs of best perfoorming model for each dataset against the
% performance of the recurrence scoring functioon
DiffAUC = BestAUC - RecurrenceAUC'

%% Save results
save RecurrenceAuditorResults.mat BestAUC RecurrenceAUC DiffAUC
