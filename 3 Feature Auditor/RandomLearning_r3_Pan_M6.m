%RandomLearning_r3_Pan_M6
% Process: Feature Auditor
% Data: Pan dataset
% Framework: M6 (F6)
% Manipulation: Masking features with random numbers, method r3
% 11.25.2018
...
%% Features
load Features_M6_PanHH_r3 DistSign_Rand
...
for paramterSet=1:length(Paramters)
    ...
    for k=1:training_rounds
        ...
        %% Precomputed Kernel
        %M6 Kernel: Gaussianized + Symmteric+ non-normalized for length
